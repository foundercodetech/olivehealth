...
class _TotalcollectionState extends State<Totalcollection> with SingleTickerProviderStateMixin{
  ...
  List<CollectionTabViewlist> getSelectedSubItems() {
    return subItem.where((item) => item.code == selectedCatTitle).toList();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text("Collection",style: robotoRegular.copyWith(fontSize: widths*0.045,color: whitecolor,fontWeight: FontWeight.w500),),
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(10),
                                color: selectedIndex==index?Colors.orange.shade100:whitecolor,
                                ...
                                children: [
                                  Text(itemCategories[index].title,
                                    style: robotoRegular.copyWith(fontSize: widths*0.035,
                                        color:selectedIndex==index?orangecolor:textblack,fontWeight: FontWeight.bold),),
                                  Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text(itemCategories[index].Rupees,
                                        style: robotoRegular.copyWith(fontSize: widths*0.035,
                                            color:selectedIndex==index?orangecolor:textblack,fontWeight: FontWeight.w500
                                        ),),
                                      SizedBox(height: heights*0.01,),
                                      Text(itemCategories[index].date,
                                        style: robotoRegular.copyWith(fontSize: widths*0.03,
                                            color:selectedIndex==index?orangecolor:textblack),),
                                    ],
                                  ),
            ...
            child: ListView.builder(
                ...
                itemBuilder: (BuildContext, int index){
                  return Padding(
                    ...
                    child: Card(
                      elevation: 5,
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10),side: const BorderSide(color: orangecolor)),
                      child: Container(
                        height: heights*0.12,
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(listview[index].rupees,style: robotoRegular.copyWith(fontSize: widths*0.04,color: orangecolor,fontWeight: FontWeight.bold)),
                            ],
                          ),
                        ),
                      ),
